 ...
 * 
 * <p>
 * An opening parenthesis, <b>(</b>, means he should go up one floor, and a
 * closing parenthesis, <b>)</b>, means he should go down one floor. The
...
public class FloorFinder {
	...
	public static void main(String[] args) {
		Map<String, Integer> floorMap = findFloor(InputReader
				.getFileInputAsString(PUZZLE_INPUT_PATH));

		System.out.println("Santa is on floor " + floorMap.get(FLOOR_KEY));
		System.out.println("Santa first entered the basement at index "
				+ floorMap.get(BASEMENT_KEY));
	 ...
	 * @return
	 */
	public static Map<String, Integer> findFloor(String input) {
